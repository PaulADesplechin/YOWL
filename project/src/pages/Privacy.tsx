  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <p className="text-gray-700 text-lg sm:text-base mb-8">
        Dernière mise à jour : 06/02/2025 </p>
      <p className="text-gray-700 leading-relaxed text-lg sm:text-base mb-8">
        ...
        Cette politique de confidentialité décrit les types de données que nous collectons,
        comment elles sont utilisées et stockées, ainsi que vos droits en matière de confidentialité. </p>
      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            Conformément au Règlement Général sur la Protection des Données (RGPD - UE 2016/679), nous
            collectons et traitons les données suivantes : </p>
          <ul className="list-disc ml-6 mt-4 space-y-2 text-gray-700 text-lg sm:text-base">
            ...
            <li>Données techniques : adresse IP, données de connexion, type d’appareil,
              système d’exploitation, navigateur utilisé, logs de serveur.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            Le traitement de vos données repose sur les bases légales suivantes, conformément au RGPD : </p>
          <ul className="list-disc ml-6 mt-4 space-y-2 text-gray-700 text-lg sm:text-base">
            <li>Votre consentement (Article 6.1.a du RGPD) : Nous obtenons votre consentement explicite
              pour certaines opérations de traitement, notamment pour l’envoi de newsletters et notifications.</li>
            <li>Exécution du contrat (Article 6.1.b du RGPD) : Le traitement des données est nécessaire à la
              fourniture des services proposés par notre plateforme.</li>
            <li>Obligations légales (Article 6.1.c du RGPD) : Nous pouvons être amenés à traiter vos données
              pour respecter des obligations légales.</li>
            <li>Intérêts légitimes (Article 6.1.f du RGPD) : Nous pouvons traiter vos données dans le cadre
              de nos intérêts légitimes (par exemple, améliorer nos services ou prévenir des fraudes).</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            En vertu du RGPD, vous disposez des droits suivants concernant vos données personnelles : </p>
          <ul className="list-disc ml-6 mt-4 space-y-2 text-gray-700 text-lg sm:text-base">
            ...
            <li>Droit à la portabilité : Vous avez le droit de recevoir vos données dans un format structuré et couramment utilisé,
              ou de les transférer à un autre responsable de traitement.</li>
            <li>Droit d'opposition : Vous pouvez vous opposer au traitement de vos données pour des raisons légitimes.</li>
            <li>Droit de retirer votre consentement : Vous pouvez retirer votre consentement
              à tout moment, ce qui n'affectera pas la légalité du traitement effectué avant le retrait.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            ...
            pour lesquelles elles ont été collectées, conformément à la législation applicable : </p>
          <ul className="list-disc ml-6 mt-4 space-y-2 text-gray-700 text-lg sm:text-base">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            Nous mettons en place des mesures techniques et organisationnelles rigoureuses
            pour garantir la sécurité de vos données personnelles, telles que : </p>
          <ul className="list-disc ml-6 mt-4 space-y-2 text-gray-700 text-lg sm:text-base">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            Si nous transférons vos données en dehors de l'Espace Économique Européen (EEE),
            nous nous assurons que des garanties appropriées sont mises en place, conformément aux exigences du RGPD. </p>
        </section>

        <section>
          <h2 className="text-3xl font-semibold mb-4 sm:text-2xl">7. Cookies et Technologies Similaires</h2>
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            Nous utilisons des cookies et autres technologies similaires pour
            améliorer votre expérience sur notre plateforme. Pour en savoir plus, veuillez consulter notre
            Politique relative aux Cookies, disponible sur notre site. </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            ...
            En cas de changement, nous vous en informerons via une notification sur notre plateforme
            ou par email. La version mise à jour sera disponible sur cette page avec la date de révision. </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-lg sm:text-base">
            ...
            vos droits, vous pouvez nous contacter à : </p>
          <ul className="list-disc ml-6 mt-4 space-y-2 text-gray-700 text-lg sm:text-base">
